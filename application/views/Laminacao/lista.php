<!DOCTYPE html>
<html lang="pt-br">
    <?php $this->load->view('_include/head', ['titulo' => 'Laminação']); ?>
    <?php $this->load->view('_include/dataTable', ['controler' => 'laminacao']); ?>
    <body>
        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a class="btn btn-default inserir" href="<?= base_url('laminacao/form') ?>"><span class="glyphicon glyphicon-plus"></span></a>
                        </div>
                        <div class="col-md-6">
                        </div>
