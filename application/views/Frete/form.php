        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!--ID-->
                    <?= form_hidden('id', $frete->id) ?>

                    <!--Nome-->
                    <div class="form-group">
                        <?= form_label('Nome: ', 'nome', array('class' => 'control-label col-sm-2')) ?>
                        <div class="col-sm-5">
                            <?= form_input('nome', $frete->nome, ' id="nome" class="form-control" placeholder="Nome"') ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <?= form_textarea('descricao', $frete->descricao, ' id="descricao" class="form-control" placeholder="Descrição"') ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <?= form_input('valor', $frete->valor, ' id="valor" class="form-control" placeholder="Valor"') ?>
                        </div>
                    </div>
